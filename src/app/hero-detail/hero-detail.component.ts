...
export class HeroDetailComponent implements OnInit {
  ...
  of parameters extracted from the URL. The "id" parameter is the id of
  the hero to display.
  ...
  */
  ...
  /**
   * Add a goBack() method to the component class that navigates backward one
   * step in the browser's history stack using the Location service that
   * you injected previously. 
   */
  goBack(): void {
    this.location.back();
  }
